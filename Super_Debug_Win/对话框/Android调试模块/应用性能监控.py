...
from 工具.Android调试模块.ADB工具 import Adb设备操作
from 对话框.Android调试模块.设备性能监控 import ScrollChart
from 工具.Android调试模块.图表JS import load_chart_js
...
class 应用性能监控(QWidget):
    ...
    def _fetch_device_info_task(self):
        ...
        # 1) 先获取 getprop
        try:
            from 对话框.Android调试模块.设备信息对话框 import 设备信息_属性字典, _B_IDS
