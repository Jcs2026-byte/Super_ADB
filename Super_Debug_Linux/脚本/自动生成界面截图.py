...
_output_dir = os.path.join(os.path.dirname(_project_root), '项目说明', '截图')
...
def main():
    ...
    try:
        from 对话框.WiFi配对对话框 import WiFi配对对话框
        dlg = WiFi配对对话框()
    ...
    try:
        from 对话框.WiFi历史对话框 import WifiHistoryDialog
    ...
    try:
        from 对话框.局域网扫描对话框 import 局域网扫描对话框
        dlg = 局域网扫描对话框()
    ...
    try:
        from 对话框.scrcpy_设置对话框 import Scrcpy设置对话框
        dlg = Scrcpy设置对话框()
