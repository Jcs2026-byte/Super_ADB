...
# 2. 使用 spec 文件打包
pyinstaller --clean --noconfirm 打包/Super_ADB_linux.spec

# 3. 修复执行权限
chmod +x 打包/dist/Super_ADB/Super_ADB
find 打包/dist/Super_ADB -name "adb" -o -name "scrcpy" | xargs chmod +x
