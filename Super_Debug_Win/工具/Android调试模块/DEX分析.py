...
# 2026-09 适配：去除本机硬编码路径；用法：python DEX分析.py [apk提取目录]
BASE = (sys.argv[1] if len(sys.argv) > 1 else "") or "./"
BASE = BASE if BASE.endswith("/") or BASE.endswith(os.sep) else BASE + os.sep
