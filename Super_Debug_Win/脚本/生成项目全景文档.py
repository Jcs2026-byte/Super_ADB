...
生成项目全景文档
================
自动扫描 Super_Debug_Win/ 项目结构、类继承、依赖关系，
生成包含 mermaid 图表的完整 HTML 项目全景文档。

用法：
    python Super_Debug_Win/脚本/生成项目全景文档.py
...
WIN_ROOT = PROJECT_ROOT / 'Super_Debug_Win'
...
def 获取按钮功能清单():
    ...
    返回 [(按钮名, 按钮文字, 处理函数)]
    """
    main_file = WIN_ROOT / '项目启动入口' / 'Super_Debug_主入口.py'
    ui_file = WIN_ROOT / '项目UI' / 'Super_Debug.py'
...
def scan_imports():
    """扫描模块间导入依赖，返回 [(源包, 目标包)]。"""
    # 动态获取所有包名（Super_Debug_Win/ 下的子目录）
...
def 生成对话框模拟截图(跳过=False):
    ...
    for stem in files:
        ...
        try:
            ...
            成功列表.append((stem, cls_name, f'项目说明/截图/对话框/{stem}.png', doc))
            print(f'    ✅ {stem}')
        except Exception as e:
...
def 生成主界面截图(跳过=False):
    ...
    try:
        ...
        # 导入主窗口
        from 项目启动入口.Super_Debug_主入口 import 主窗口
...
def build_structure_tree(files, package_desc):
    ...
    html_lines.extend(render_node('Super_Debug_Win', tree, is_root=True))
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/主界面.png" alt="主界面" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/无线调试.png" alt="无线调试" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/文件管理.png" alt="文件管理" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/日志抓取.png" alt="日志抓取" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/性能监控.png" alt="性能监控" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/Monkey压测.png" alt="Monkey压测" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/安装解包.png" alt="安装解包" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/网络抓包.png" alt="网络抓包" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/投屏.png" alt="投屏" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/便捷工具.png" alt="便捷工具" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/PCAP解析.png" alt="PCAP解析" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 PCAP解析截图<br><span>放置于 项目说明/截图/PCAP解析.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/ADB终端.png" alt="ADB终端" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 ADB终端截图<br><span>放置于 项目说明/截图/ADB终端.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/IP扫描.png" alt="IP扫描" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 IP扫描截图<br><span>放置于 项目说明/截图/IP扫描.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/JSON工具.png" alt="JSON工具" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 JSON工具截图<br><span>放置于 项目说明/截图/JSON工具.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/WiFi管理.png" alt="WiFi管理" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 WiFi管理截图<br><span>放置于 项目说明/截图/WiFi管理.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/WiFi配对.png" alt="WiFi配对" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 WiFi配对截图<br><span>放置于 项目说明/截图/WiFi配对.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/环境配置.png" alt="环境配置" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 环境配置截图<br><span>放置于 项目说明/截图/环境配置.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/设备信息.png" alt="设备信息" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 设备信息截图<br><span>放置于 项目说明/截图/设备信息.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/时间戳转换.png" alt="时间戳转换" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 时间戳转换截图<br><span>放置于 项目说明/截图/时间戳转换.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/修改时间.png" alt="修改时间" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 修改时间截图<br><span>放置于 项目说明/截图/修改时间.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/证书安装.png" alt="证书安装" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 证书安装截图<br><span>放置于 项目说明/截图/证书安装.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/局域网扫描.png" alt="局域网扫描" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 局域网扫描截图<br><span>放置于 项目说明/截图/局域网扫描.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<div class="feature-block">
  <div class="feature-screenshot">
    <img src="项目说明/截图/哈希校验.png" alt="哈希校验" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
    <div class="screenshot-placeholder">📷 哈希校验截图<br><span>放置于 项目说明/截图/哈希校验.png</span></div>
  </div>
  <div class="feature-desc">
    <h4>功能介绍</h4>
...
<p class="section-intro">Super_Debug_Win/ 为项目根目录，按功能划分为 12 个包，所有包均含 <code>__init__.py</code>。</p>
<div class="card">
{structure_tree}
</div>
...
<div class="card">
  <table>
    ...
    <tr><td>控件定义</td><td><code>ui/Super_Debug.ui</code></td><td>Qt Designer 可视化编辑</td></tr>
    <tr><td>编译输出</td><td><code>项目UI/Super_Debug.py</code></td><td>pyside6-uic 自动生成</td></tr>
  ...
  <h4>编译命令</h4>
<pre><code>pyside6-uic "ui\\Super_Debug.ui" -o "Super_Debug_Win\\项目UI\\Super_Debug.py"
pyside6-rcc "ui\\png.qrc" -o "Super_Debug_Win\\项目UI\\png_rc.py"</code></pre>
</div>
...
<div class="card">
{config_table}
<p style="margin-top:10px;color:var(--text2);font-size:12px;">配置文件位于 <code>Super_Debug_Win/配置/</code> 目录，启动时自动加载，退出时保存窗口几何和主题。</p>
</div>
...
<div class="card">
  ...
  <ul style="margin:10px 0 10px 20px;color:var(--text);">
    ...
    <li>pathex 只加 <code>Super_Debug_Win/</code> 根目录（包式导入）；add-data 目标路径不带前导 /</li>
...
<div class="warn-box"><strong>⚠️ 包式导入：</strong>所有 import 使用包名前缀（<code>from 对话框.xxx import ...</code>），不要使用裸导入。sys.path 只加 Super_Debug_Win/ 根目录。</div>
...
<div class="card">
<pre><code># 编译 UI
pyside6-uic "ui\\Super_Debug.ui" -o "Super_Debug_Win\\项目UI\\Super_Debug.py"
pyside6-rcc "ui\\png.qrc" -o "Super_Debug_Win\\项目UI\\png_rc.py"

# 运行
python 项目启动入口/Super_Debug_主入口.py

# 生成依赖图
python Super_Debug_Win\\脚本\\生成依赖关系图.py

# 生成项目全景文档（本脚本）
python Super_Debug_Win\\脚本\\生成项目全景文档.py

# 打包
python Super_Debug_Win\\打包\\精简打包exe.py
...
def 生成功能介绍Markdown():
    """生成「功能介绍与使用说明」Markdown（包含 项目说明/截图/ 下全部截图）。"""
    features = [
    ...
    lines.append("")
    lines.append("![公众号](Super_Debug_Win/资源/公众号.jpg)")
    lines.append("")
    lines.append("## 📥 下载地址")
    lines.append("")
