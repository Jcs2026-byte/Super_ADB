...
THEMES = {
    ...
    'dark_cyan': {
        ...
        'text_primary':   '#f0f7ff',
        'text_pressed':   '#0a1320',
        'text_disabled':  '#7a8b9c',
        'text_hover':     '#ffffff',
        'border_disabled':'#48586a',
    },
    'dark_purple': {
        'name': '深色·紫罗兰',
        ...
        'text_primary':   '#f2eafa',
        'text_pressed':   '#1a1228',
        'text_disabled':  '#8a7a9c',
        'text_hover':     '#ffffff',
        'border_disabled':'#4a3f58',
    },
    'dark_amber': {
        'name': '深色·琥珀',
        'accent': 'rgb(255,200,20)',
        'bg_window':    '#332c1f',
        'bg_button':    '#3d3525',
        'bg_input':     '#262015',
        'bg_menu':      '#2c2518',
        ...
        'text_primary':   '#fff0d8',
        'text_pressed':   '#1a1408',
        'text_disabled':  '#988868',
        'text_hover':     '#ffffff',
        'border_disabled':'#554a30',
    },
    'dark_crimson': {
        'name': '深色·深红',
        ...
        'text_primary':   '#ffe8e8',
        'text_pressed':   '#1a0808',
        'text_disabled':  '#986868',
        'text_hover':     '#ffffff',
        'border_disabled':'#553333',
    },
    'dark_neon': {
        'name': '深色·霓虹黑',
        ...
        'text_primary':   '#e0fff0',
        'text_pressed':   '#001a0d',
        'text_disabled':  '#507060',
        'text_hover':     '#ffffff',
        'border_disabled':'#353535',
    },
    'light_soft': {
        'name': '浅色·晴空',
    ...
    'minimal_gray': {
        ...
        'text_primary':   '#e0e4e8',
        'text_pressed':   '#1a1d21',
        'text_disabled':  '#707880',
        'text_hover':     '#ffffff',
        'border_disabled':'#454a52',
    },
    'minimal_ios': {
        'name': '简约·深空灰',
...
def get_stylesheet(theme_id=DEFAULT_THEME):
    ...
    /* ────────────── 工具提示 QToolTip ────────────── */
    /* 全局 QWidget 规则会刷到 QToolTip 背景，但文字走 ToolTipText 角色
       （QSS color 改不到），深色主题下出现深底黑字。此处显式指定。 */
    QToolTip {{
        background-color: {t['bg_menu']};
        color: {t['text_primary']};
        border: 1px solid {accent};
...
THEME_CONFIG_FILE = '配置/Super_ADB配置.json'
