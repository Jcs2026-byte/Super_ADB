    ...
    def _install_context_menu(self):
        try:
            ...
            if getattr(sys, 'frozen', False):
                ...
                icon_candidates.append(os.path.join(_file_dir, '../..', 'ui', 'Super_Debug.ico'))
                icon_candidates.append(os.path.join(_file_dir, '../..', '资源', 'Super_Debug.ico'))
                icon_candidates.append(os.path.join(_file_dir, '../..', 'Super_Debug.ico'))
                # 冻结版目录兜底（开发态若与打包目录混用）
