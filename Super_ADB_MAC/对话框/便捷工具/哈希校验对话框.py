    ...
    def _install_context_menu(self):
        try:
            ...
            if getattr(sys, 'frozen', False):
                ...
                icon_candidates.append(os.path.join(_file_dir, '../../../Super_ADB_Linux', 'ui', 'Super_ADB.ico'))
                icon_candidates.append(os.path.join(_file_dir, '../../../Super_ADB_Linux', '资源', 'Super_ADB.ico'))
                icon_candidates.append(os.path.join(_file_dir, '../../../Super_ADB_Linux', 'Super_ADB.ico'))
                # 冻结版目录兜底（开发态若与打包目录混用）
