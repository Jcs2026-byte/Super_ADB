...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cmdBtn = QPushButton(self.groupBox)
        self.cmdBtn.setObjectName(u"cmdBtn")

        self.horizontalLayout_2.addWidget(self.cmdBtn)
...
#if QT_CONFIG(tooltip)
        self.cmdBtn.setToolTip(QCoreApplication.translate("MainWindow", u"\u6253\u5f00 ADB shell \u4ea4\u4e92\u5f0f\u7ec8\u7aef", None))
#endif // QT_CONFIG(tooltip)
        self.cmdBtn.setText(QCoreApplication.translate("MainWindow", u"adb shell \u547d\u4ee4\u884c", None))
