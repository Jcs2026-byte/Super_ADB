...
=====================================================
静态 AST 解析 Super_Debug_Win 下所有 .py 的 import / from ... import
...
HERE = Path(__file__).resolve().parent          # .../Super_Debug_Win/脚本
ROOT = HERE.parent                               # .../Super_Debug_Win
...
def build_dot(mods, order, edges) -> "tuple[int, int]":
    ...
    for gname in ["root", "对话框", "页面", "监控", "工具", "脚本", "打包"]:
