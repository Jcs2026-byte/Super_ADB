...
from 工具.Android调试模块.ADB工具 import AdbHelper, AdbFileManager, CREATE_NO_WINDOW
from 工具.Android调试模块.自研adb.adb协议 import CMD_OKAY, CMD_WRTE, CMD_CLSE, AdbMessage
from 工具.Android调试模块.自研adb.adb协议 import 借用连接 as _adb_borrow, 剥离连接 as _adb_detach
...
# 注册 png_rc 资源（应用图标 :/Super_Debug.png）
...
class Tcpdump对话框(QWidget):
    ...
    def _自动推送tcpdump(self):
        ...
        try:
            ...
            import glob
            # 兼容源码模式（Super_Debug_Win/外部扩展/）与冻结模式（_internal/外部扩展/）
